...
This example demonstrates the basic usage of the `progressModifier` function to control the transition between different models. Here we have a simple cubic bezier curve applied to the progress value.
